...
const mergeKSortedListsHeap = (lists) => {
...
exports.default = () => {
    ...
    (0, LinkedListClass_1.PrintList)(mergeKSortedListsHeap([listA1.head, listA2.head, listA3.head]));
    (0, LinkedListClass_1.PrintList)(mergeKSortedListsHeap([listB1.head, listB2.head]));
};

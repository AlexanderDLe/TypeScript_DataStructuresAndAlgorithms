...
const mergeA = (nums1: number[], m: number, nums2: number[], n: number): void => {
    while (nums1.length > m) nums1.pop();
    while (nums2.length > n) nums2.pop();
...
const mergeB = (nums1: number[], m: number, nums2: number[], n: number): void => {
    while (nums1.length > m) nums1.pop();
    while (nums2.length > n) nums2.pop();

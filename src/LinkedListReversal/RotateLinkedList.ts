...
const rotateLinkedList = (head: Node, rotations:number): Node => {
...
export default () => {
    let list1 = new LinkedList([1,2,3,4,5,6])
    let k1 = 3;
    ...
    list1.print();
    PrintList(rotateLinkedList(list1.head, k1));

    list2.print();
    PrintList(rotateLinkedList(list2.head, k2));
};